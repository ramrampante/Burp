# Burp + AWS S3 with Node.JS

A simple and fully working example of Burp and AWS S3 storage with Node.js (and
...
```sh
corepack yarn workspace @Burp-example/aws-nodejs start
```
